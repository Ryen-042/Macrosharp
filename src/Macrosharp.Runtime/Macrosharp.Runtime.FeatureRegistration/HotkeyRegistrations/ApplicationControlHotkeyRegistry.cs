...
public static class ApplicationControlHotkeyRegistry
{
    ...
    {
        hotkeyManager.RegisterHotkey(VirtualKey.ESCAPE, Modifiers.WIN, onConfirmExit, description: "Prompt to terminate Macrosharp.", sourceContext: sourceContext);
        ...
        hotkeyManager.RegisterHotkey(VirtualKey.DELETE, Modifiers.SHIFT_WIN, onClearConsole, description: "Clear console output.", sourceContext: sourceContext);

        hotkeyManager.RegisterHotkey(VirtualKey.INSERT, Modifiers.SHIFT_WIN, onToggleConsoleVisibility, description: "Toggle console window visibility.", sourceContext: sourceContext);

        hotkeyManager.RegisterHotkey(VirtualKey.KEY_P, Modifiers.CTRL_ALT_WIN, onTogglePauseResume, description: "Pause or resume keyboard and mouse automation.", sourceContext: sourceContext);

        hotkeyManager.RegisterHotkey(VirtualKey.KEY_B, Modifiers.CTRL_ALT_WIN, onToggleBurstClick, description: "Toggle burst click (start when inactive, stop when active).", sourceContext: sourceContext);
